        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <svg className="w-16 h-16 fill-current text-purple-600" viewBox="105.452 141.316 236 166.8" xmlns="http://www.w3.org/2000/svg">
              ...
              <text style={{fillRule: 'evenodd', fontFamily: 'Calistoga', fontSize: '107px', paintOrder: 'fill', whiteSpace: 'pre'}} x="249.369" y="255.215">U</text>
              <text style={{fillRule: 'evenodd', fontFamily: 'Calistoga', fontSize: '107px', paintOrder: 'fill', whiteSpace: 'pre'}} x="133.959" y="255.847">A</text>
            </svg>
            </Link>
              </div>
